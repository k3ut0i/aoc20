...
I am trying a ASP solution to this problem. First part works perfectly and the examples are working for the second part but my answer is wrong for the actual problem. I don't understand why?
#+begin_src julia
  write_rules_prolog("inputs/day7", "day7facts.prolog") # rewrite input as facts 
#+end_src
#+begin_src sh :session *day7* :results output verbatim
  clingo -V0 day7facts.prolog src/day7.lp 
#+end_src

#+RESULTS:
: bagsInShiny(16555) shinyInBags(128)
: SATISFIABLE
